...
challenges: {
        ...
        22: {
            ...
            canComplete: function() {return player.SL.points.gte(1500000)},
            goalDescription: "1,500,000 Souls",
            ...
            onExit(){player.SL.keep = true, player.SL.upgrades.push("11", "12", "13", "14", "15", "21") = true},
            unlocked(){
