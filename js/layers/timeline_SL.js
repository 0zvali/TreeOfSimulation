addLayer("SL", {
    ...
    effectDescription() {
        ...
        if (hasUpgrade('SL', 21)) dis = "which is boosting floor gain by "+format(tmp.SL.effect)+`x<br>` + "and dividing explosive & floor requirement by /"+format((player.SL.points.max(1).add(1).pow(0.35).div(3)).max(1))
        return dis
    },
    effectBase() {
