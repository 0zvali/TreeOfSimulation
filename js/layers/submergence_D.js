            ...
            content: [
                ...
                ["display-text", 
                    function() {
                        ...
                        if (hasUpgrade('D', 43)) display = "Distortion Effects:<br>'Distorted Room' Upgrade Effect: " + format((player.O.points.max(1).add(1).pow(0.03)).max(1).min("1e85000")) +'x Obfuscation Effect<br> Increase the Weapon Effect from e12,500 -> e37,500<br> "R3alIz@ti0n" effect is now 1.2x higher<br> Distortion boosts Obfuscation by ' + format((player.D.points.max(1).add(1).pow(0.34)).max(1).min("1e33000")) + 'x<br> Distortion Effect is  now ^' + format((player.points.max(1).add(1).log10(6).pow(0.2)).max(1).min(1.9)) + ' higher'
                        return display
                        },
                    {}],
                "blank",
