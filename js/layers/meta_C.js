...
upgrades: {
        ...
        21: {
            ...
            effect() {
                ...
                if (hasUpgrade('mH', 31)) cap = cap.times(1e440)
        ...
        24: {
            ...
            effect() {
                ...
                if (hasUpgrade('mH', 31)) cap = cap.times(6.6e666)
        ...
        25: {
            ...
            effect() {
                ...
                if (hasUpgrade('mH', 31)) cap = cap.times(1e320)
        ...
        26: {
            ...
            effect() {
                ...
                if (hasUpgrade('mH', 31)) cap = cap.times(1e250)
