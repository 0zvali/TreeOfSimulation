...
<h3>Inspired By:</h3><br> <a v-bind:href="'https://thecamelliatree.github.io/The-Camellia-Tree-Rewritten/'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >The Camellia Tree</a>, <a v-bind:href="'https://thenonymous.github.io/The-Random-Tree/'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >The Plant Tree</a>, <a v-bind:href="'https://raw.githack.com/jezzacozzie/The-Fame-Tree/master/index.html'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >The Fame Tree</a>, <a v-bind:href="'https://raw.githack.com/p-u/The-Point-Tree/master/index.html'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >The Point Tree</a>.
		<br><br>
