...
if (player.CT.points.gte(2) && player.points.gte(1e35)) nerf = "Infect gain is nerfed by /" + format((player.points.minus(1e10).add(1).pow(0.112)).times(7.2).times(35).div(9.2).times(3500) + " (Level 4 Nerf)"
