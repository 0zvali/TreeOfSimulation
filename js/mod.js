...
function getPointGen() {
	...
	if (player.CT.points.gte(2) && player.points.gte("1e1700")) gain = gain.pow(new Decimal(1).minus(player.points.log10().div(100000)))
...
var displayThings = [
	...
	function () {
		...
		if (player.CT.points.gte(2) && player.points.gte("1e1700")) nerf = "Infect gain is nerfed by ^" + format(new Decimal(1).minus(player.points.log10().div(100000))) + " (Level 1 Hardcap)"
		return nerf
	},
]
